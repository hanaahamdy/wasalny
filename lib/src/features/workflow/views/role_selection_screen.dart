...
class _RoleSelectionScreenState extends State<RoleSelectionScreen> {
  Future<void> _openExistingCycle(UserRole type) async {
    final user = UserModel.initial().copyWith(
      name: type == UserRole.admin ? 'Admin' : 'Delivery',
      email: widget.email,
      role: type,
    );
  ...
  Widget build(BuildContext context) {
    final roles = <_RoleData>[
      ...
      _RoleData(
        ...
        color: AppColors.scenarioPrimary,
        onTap: () => _openExistingCycle(UserRole.delivery),
      ),
      _RoleData(
            ...
            children: [
              ...
              FilledButton.icon(
                ...
                onPressed: () {
                  ...
                  _openExistingCycle(UserRole.admin);
                },
