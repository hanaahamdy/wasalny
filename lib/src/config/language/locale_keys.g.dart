...
abstract class LocaleKeys {
  ...
  static const String _adminHome = 'admin_home';
  static String get adminHome => _adminHome.tr();

  static const String _adminHomeSubtitle = 'admin_home_subtitle';
  static String get adminHomeSubtitle => _adminHomeSubtitle.tr();

  static const String _createOrders = 'create_orders';
  static String get createOrders => _createOrders.tr();
  ...
  static const String _orderInfo = 'order_info';
  static String get orderInfo => _orderInfo.tr();

  static const String _ordersAdminSubtitle = 'orders_admin_subtitle';
  static String get ordersAdminSubtitle => _ordersAdminSubtitle.tr();

  static const String _ordersDeliverySubtitle = 'orders_delivery_subtitle';
  static String get ordersDeliverySubtitle => _ordersDeliverySubtitle.tr();

  static const String _latestOrders = 'latest_orders';
  static String get latestOrders => _latestOrders.tr();
  ...
  static const String _paymentStatus = 'payment_status';
  static String get paymentStatus => _paymentStatus.tr();

  static const String _paymentOnReceive = 'payment_on_receive';
  static String get paymentOnReceive => _paymentOnReceive.tr();

  static const String _customerInfo = 'customer_info';
  static String get customerInfo => _customerInfo.tr();

  static const String _customerName = 'customer_name';
  static String get customerName => _customerName.tr();

  static const String _orderAddress = 'order_address';
  static String get orderAddress => _orderAddress.tr();

  static const String _paymentMethod = 'payment_method';
  static String get paymentMethod => _paymentMethod.tr();

  static const String _dealDetails = 'deal_details';
  static String get dealDetails => _dealDetails.tr();

  static const String _dealName = 'deal_name';
  static String get dealName => _dealName.tr();

  static const String _piecesCount = 'pieces_count';
  static String get piecesCount => _piecesCount.tr();

  static const String _pricing = 'pricing';
  static String get pricing => _pricing.tr();

  static const String _returnPrice = 'return_price';
  static String get returnPrice => _returnPrice.tr();
  ...
  static String get orderTime => _orderTime.tr();
  ...
  static const String _enterFullName = 'enter_full_name';
  static String get enterFullName => _enterFullName.tr();

  static const String _selectTheLocation = 'select_the_location';
  static String get selectTheLocation => _selectTheLocation.tr();

  static const String _enterTheEmail = 'enter_the_email';
  static String get enterTheEmail => _enterTheEmail.tr();

  static const String _clientPhoneNumber = 'client_phone_number';
  static String get clientPhoneNumber => _clientPhoneNumber.tr();

  static const String _enterPhoneNumber = 'enter_phone_number';
  static String get enterPhoneNumber => _enterPhoneNumber.tr();

  static const String _totalCost = 'total_cost';
  static String get totalCost => _totalCost.tr();

  static const String _deliveryPrice = 'delivery_price';
  static String get deliveryPrice => _deliveryPrice.tr();

  static const String _productName = 'product_name';
  static String get productName => _productName.tr();

  static const String _pieceOrProductName = 'piece_or_product_name';
  static String get pieceOrProductName => _pieceOrProductName.tr();

  static const String _clientName = 'client_name';
  static String get clientName => _clientName.tr();

  static const String _numberOfPieces = 'number_of_pieces';
  static String get numberOfPieces => _numberOfPieces.tr();
  ...
  static const String _enterPhoneNumberOrEmail = 'enter_phone_number_or_email';
  static String get enterPhoneNumberOrEmail => _enterPhoneNumberOrEmail.tr();

  static const String _createdOrders = 'created_orders';
  static String get createdOrders => _createdOrders.tr();
